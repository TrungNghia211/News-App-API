...
urlpatterns = [
    ...
    path('articles/', views.article_create_by_subcategory, name='article-create-by-subcategory'),  
    path('articles/all/', views.article_get_all, name='article_get_all'),
    path('comments/article/<int:article_id>/', views.add_comment, name='add-comment'),
